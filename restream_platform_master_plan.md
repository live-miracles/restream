...
- `test/run-protocol-matrix.sh` now handles `--help` and `--list-modes`
  without compiling, while real runs use `scripts/resource-limit` for the Rust
  orchestrator build/run step.
