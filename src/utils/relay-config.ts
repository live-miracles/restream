...
const RELAY_CONFIG_PATH = path.join(__dirname, '..', '..', 'srt-bonding-relay.json');
...
const DEFAULT_RELAY_CONFIG: SrtBondingRelayConfig = {
    input_host: '0.0.0.0',
    input_port: 10081,
...
function normalizeRelayConfig(raw: unknown): SrtBondingRelayConfig {
